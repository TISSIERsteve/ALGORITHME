...
// CORRIGER
let secondes = parseInt(prompt("Veuillez saisir les secondes"));
let minutes = parseInt(prompt("Veuillez saisir les minutes"));
let heures = parseInt(prompt("Veuillez saisir les heures"));
...
secondes = secondes === 0 ? "00" : secondes;
secondes = ("0" + secondes).slice(-2);
minutes = minutes === 0 ? "00" : minutes;
minutes = ("0" + minutes).slice(-2);
heures = heures === 0 ? "00" : heures;
